...
- **Web app (Hackathon project)**: [Sketch2model](https://github.com/epsalt/sketch2model-web) - a browser-based app to turn back-of-the-napkin geological sketches into geologic models that can then be used to generate synthetic seismic sections: ![flow](https://raw.githubusercontent.com/mycarta/sketch2model/master/workflow.PNG).
